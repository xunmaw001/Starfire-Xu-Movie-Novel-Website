            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">小说评论展示</span>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 xiaoshuoLiuyanContent 字段去除无用字符 如果字段长度大于60  就截取到60
            xiaoshuoLiuyanContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                                                    // 获取列表数据
            http.request('xiaoshuoLiuyan/list', 'get', param, function(res) {
