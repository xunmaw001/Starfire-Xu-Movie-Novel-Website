              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  xiaoshuoList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../xiaoshuo/detail.jsp?id='+item.id)">
                                            <img :src="item.xiaoshuoPhoto?item.xiaoshuoPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.xiaoshuoName}}</p>
                                            <p style="color: red;" v-if="item.xiaoshuoNewMoney">{{item.xiaoshuoNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../xiaoshuo/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../dianying/detail.jsp?id='+item.id)">
                                            <img :src="item.dianyingPhoto?item.dianyingPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`xiaoshuo/list`, 'get', {
            ...
            vue.xiaoshuoList = res.data.list;
        });
