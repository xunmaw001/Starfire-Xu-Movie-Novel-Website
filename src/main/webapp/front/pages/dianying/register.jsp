              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">电影名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="dianyingName" id="dianyingName"  placeholder="电影名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">电影类型:</span>
                        <div class="layui-input-inline">
                            <select name="dianyingTypes" id="dianyingTypes" lay-filter="dianyingTypes" style="width: 600px;">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery', 'laydate'], function() {
      ...
      function dianyingTypesSelect() {
        //填充下拉框选项
          http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=dianying_types", "GET", {}, (res) => {
              if(res.code == 0){
