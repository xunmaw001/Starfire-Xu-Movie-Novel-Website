              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">小说名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xiaoshuoName" id="xiaoshuoName"  placeholder="小说名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">小说类型:</span>
                        <div class="layui-input-inline">
                            <select name="xiaoshuoTypes" id="xiaoshuoTypes" lay-filter="xiaoshuoTypes" style="width: 600px;">
