            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">电影收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="dianyingName" id="dianyingName" placeholder="电影名称" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <select name="dianyingTypes" id="dianyingTypes" lay-filter="dianyingTypes">
                                      <option value="">--请选择--</option>
                                      <option v-for="item in dianyingTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                                  </select>
                              </div>
                          </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            var dianyingTypes = $("#dianyingTypes").find("option:selected").val();
            if (dianyingTypes != null && dianyingTypes != "" && dianyingTypes != "null") {
                            param['dianyingTypes'] = dianyingTypes;
                        }
...
// 级联表的字典表
       ...
       function dianyingTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=dianying_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.dianyingTypesList = res.data.list;
               }
           });
       }
