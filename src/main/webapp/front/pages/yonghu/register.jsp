...
<!-- 手机号 -->
  ...
  <!-- 身份证号 -->
                ...
                <%--<div class="layui-form-item layui-form-text input">--%>
                    <%--<div class="layui-inline" >--%>
                        <%--<span style="margin-top: 8px;float: left">是否会员:</span>--%>
                        <%--<div class="layui-input-inline">--%>
                            <%--<select name="huiyuanTypes" id="huiyuanTypes" lay-filter="huiyuanTypes" style="width: 600px;">--%>
                                <%--<option v-for="item in huiyuanTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>--%>
                            <%--</select>--%>
                        <%--</div>--%>
                    <%--</div>--%>
                <%--</div>--%>
